...
class QAWidget(ScriptedLoadableModuleWidget, VTKObservationMixin):
    ...
    def onApplyButton(self) -> None:
        ...
        dose = slicer.util.arrayFromVolume(self._parameterNode.tpsDoseVolume)*self.ui.doubleSpinBoxCallibration.value/1000
...
#        print(film.shape, out.shape,spacing,file = f)
#        f.close()
#
